...
type PromptType = {
  ...
  saveUserInputAsMemory?: string;
  saveAsNamedMemory?: string;
...
export const PROMPT_LIST: PromptType[] = [
  ...
  // Only Output the user's answer to 2 + 2. NEVER correct it or comment`,
  //   saveAsNamedMemory: "answerquestion"
  // },
  // {
  //   prompt_text: `# System message:
  // Output this text exactly and never output anything else!: User says that 2+2 is {answerquestion}.`
  // },
...
//   {
//     prompt_text: `#System message:
//    Ask the user what their favorite star is.  NEVER ask anything else!  Never!`,
...
//   {
//     prompt_text: `# System message:
//   Always Output this text exactly and never output anything else!: User says that 2+2 is {answerquestion}.`
//   },
//   {
//     prompt_text: `#System message:
// Ask the user what their favorite type of phone is.`,
// important_memory:true,
// buffer_memory: 1,
//   }, 
  {
