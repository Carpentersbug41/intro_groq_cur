...
chaining: false, // ✅ Always include chaining
  ...
  {
    prompt_text: `#System message:
 You are an expert in outputting the essay introduction written by the user,EXACTLY as hey ahve written it.  You never correct the user's introduction..
...
chaining: false, // ✅ Always include chaining
  ...
  {
   "prompt_text": `# System message:
 You are an AI language model trained to extract the main topic statement from a given IELTS question statement. The topic statement is the core idea of the question provided to the user, excluding any instructions about how to respond.  The topic staement is NOT the user's introduction.
