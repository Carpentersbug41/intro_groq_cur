// src/app/api/chat/handlers/streamingFlow.ts // Updated Path

// import { Response } from 'next/server'; // Remove this import, Response is global
import PROMPT_LIST from "../prompts/opinionPrompts"; // Corrected path: Use renamed file
import { manageBuffer } from '../utils/bufferUtils';
import { DEFAULT_OPENAI_MODEL, OPENAI_API_URL } from '../utils/openaiApiUtils'; // Import constants
import { ConversationEntry } from '../types/routeTypes'; // Import type
import { streamAsyncIterable } from '../utils/streamUtils'; // Go up one level

/**
 * Helper to turn a ReadableStream into an async iterable
 */
// Moved to streamUtils.ts
