...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("[DEBUG] Pushing user message to conversation history...");
    ...
    // We do currentIndex - 1 because we just advanced index after the user input was validated.
    ...
    // 7) Possibly chain next prompts ONLY if the new prompt is chaining
